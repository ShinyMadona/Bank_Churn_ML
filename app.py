...
def load_and_train_model():
    ...
    # Load both sheets
    customer_df = pd.read_excel('Bank_churn_Account_info_sample.xlsx')
    account_df = pd.read_excel('Bank_churn_Customer_info_sample.xlsx')
...
with col2:
    ...
    estimated_salary = st.number_input("EstimatedSalary", min_value=0.0, value=500000.0, step=10000.0)
